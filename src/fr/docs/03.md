...
## 3.0 Morphologie de Base {#Sec3}

Ce chapitre abordera les catégories morphologiques qui sont indispensables à tout formatif, qu'il soit nominal ou verbal. Autrement dit, les emplacements morphologiques de la [Sec. 2.3](02#Sec2_3) dans un nom ou un verbe dont l'expression par des variations d'affixes est grammaticalement nécessaire, et non optionnelle. Les catégories abordées ici sont la **Configuration**, l'**Affiliation**, la **Perspective**, l'**Extension**, l'**Essence**, la **Version**, la **Fonction** et le **Contexte**.

<!-- @include: struct.md{313-468} -->

## 3.1 La Configuration {#Sec3_1}

Afin d'appréhender le concept de relations de groupe et la quantification des noms en Nouvel Ithkuil (c'est-à-dire ce que d'autres langues appellent _singulier_, _pluriel_, etc.), il faut analyser trois catégories grammaticales distinctes mais liées entre elles appelées **Configuration**, **Affiliation** et **Perspective**. Ces concepts sont étrangers aux autres langues. Bien qu'ils traitent aussi de distinctions sémantiques de nature quantitative, ces distinctions sont généralement faites au niveau lexical (c-à-d par le choix des mots) dans les autres langues, pas au niveau morphologique comme en Nouvel Ithkuil. Dans cette section, nous traiteront d'abord de la Configuration, puis de l'Affiliation dans la [Sec. 3.2](#Sec3_2), et enfin de la Perspective dans la [Sec. 3.3](#Sec3_3).

En particulier, la Configuration traite de la similarité physique ou des relations des membres d'un référent nominal au sein de groupes, d'ensembles, d'assortiments, d'arrangements ou de _gestalts_ contextuels, définis par leur composition interne, séparabilité, compartementalisation, similarité physique ou structure componentielle. La meilleure manière de l'expliquer et de l'illustrer est par analogie avec des champs lexicaux de mots français.

Considérons le mot français <q>arbre</q>. En français, un arbre unique peut se dresser seul en dehors de tout contexte, ou il peut faire partie d'un groupe d'arbres. Un tel groupe d'arbres peut simplement consister de deux arbres ou plus, et être considéré comme une catégorie plurielle basée uniquement sur le nombre, par exemple deux, trois, ou vingt arbres. Cependant, il est naturel pour des arbres d'exister en regroupements portant une signification contextuelle allant plus loin que leur simple valeur numérique. Par exemple, les arbres peuvent être de la même espèce comme dans un <q>bosquet</q>. Le regroupement peut être un assortiment de différents types d'arbres comme dans une <q>forêt</q>, ou se présenter de manière chaotique et aléatoire comme une <q>jungle</q>.

Prenons un autre exemple avec le mot français <q>personne</q>. Bien que des personnes puissent se présenter en simples regroupements numériques comme <q>une (seule) personne</q> ou <q>trois personnes</q>, il est plus commun de faire référence à des personnes par des mots indiquant divers regroupements comme <q>groupe</q>, <q>rassemblement</q>, <q>foule</q>, etc.

La segmentation et la structure de l'amalgame componentiel sont des principes configuratifs supplémentaires pour distinguer les mots du même champ lexical en français. Les liens entre les mots _voiture_ et _convoi_, _cintre_ et _penderie_, _pièce d'échecs_ et _jeu d'échecs_, _sentinelle_ et _barrage_, _feuille de papier_ et _liasse de papier_, _poutre_ et _charpente_, _pièce de monnaie_ et _rouleau de pièce de monnaie_ sont autant d'exemples de ces principes.

Un autre type de regroupement contextuel de noms est représenté par les groupes binaires, notamment concernant les parties du corps. Ces groupes binaires peuvent contenir deux référents identiques comme _une paire d'yeux_, mais ils sont plus souvent des groupes opposés ou « miroir » (c-à-d complémentaires) comme _des membres_, _des oreilles_, _des mains_, _des ailes_, etc.

Les distinctions sémantiques définies dans les examples précédents, dans leurs relations avec divers assortiments d'arbres ou de personnes, seraient obtenues en déclinant le radical pour <q>arbre</q> ou <q>personne</q> selon l'une de vingt configurations différentes. D'autres distinctions sémantiques sur la base du but ou de la fonction individuels des membres d'un groupe peuvent ensuite être exprimées avec l'Affiliation (voir la [Sec. 3.2](#Sec3_2) ci-dessous) ou des affixes spécifiques. Par exemple, une fois que les mots <q>forêt</q> ou <q>foule</q> ont été dérivés de <q>arbre</q> et <q>personne</q> _via_ la Configuration, les mots pour <q>verger</q>, <q>taillis</q>, <q>équipe</q> ou <q>bande</q> pourraient facilement être dérivés _via_ une Affiliation et des affixes (ces dérivations par affixes menant à de nouveaux mots sont explorées en détail dans le [Chapitre 7 : Les Affixes](07)).

La catégorie de la Configuration est constituée de l'amalgamation de trois facteurs distincts : **Pluralité**, **Séparabilité** et **Similarité**.

* La **Pluralité** est une triple distinction déterminant si un.e entité/événement/action/état est unique ou intérieurement unifié.e, est binaire ou naturellement divisé.e en deux moitiés, ou contient trois composants/morceaux/parties/membres ou plus. Ces trois états de Pluralité sont appelés **UNIPLEXE**, **DUPLEXE** et **MULTIPLEXE** (abrégés en <abbr>U</abbr>, <abbr>D</abbr> et <abbr>M</abbr>).

* La **Similarité** est une triple distinction déterminant si un groupe d'entités considéré comme un tout est constitué de membres individuels étant physiquement similaires les uns aux autres, physiquement dissimilaires les uns aux autres, ou dont la similarité est « floue » (c-à-d dont le degré de similarité entre les membres individuels est subjectif, indéterminable, non applicable ou difficilement définissable). Ces trois états de Similarité sont appelés **SIMILAIRE**, **DISSIMILAIRE** et **FLOU** (abrégés en <abbr>S</abbr>, <abbr>D</abbr> et <abbr>F</abbr> en <del>troisième position suivant les lettres abrégées de la Pluralité et de la Séparabilité</del> <ins>deuxième position suivant la lettre abrégée de la Pluralité</ins>). Il est à noter que la Similarité ne s'applique pas aux entités/événements/actions/états UNIPLEXES.

* La **Séparabilité** est une triple distinction déterminant si un groupe d'entités considéré comme un tout est constitué de membres individuels étant physiquement séparés les uns des autres, connectés d'une certaine manière (qu'elle soit physique, abstraite ou métaphorique), ou fusionnés ensemble (que ce soit de manière physique, abstraite ou métaphorique). Ces trois états de Séparabilité sont appelés **SÉPARÉ**, **CONNECTÉ** et **FUSIONNÉ** (abrégés en <abbr>S</abbr>, <abbr>C</abbr> et <abbr>F</abbr> en <del>deuxième position suivant la lettre abrégée de la Pluralité</del> <ins>troisième position suivant les lettres abrégées de la Pluralité et de la Séparabilité</ins>). Il est à noter que la Séparabilité ne s'applique pas aux entités/événements/actions/états UNIPLEXES.

Selon les définitions ci-dessus, il existe vingt configurations au total, indiquées _via_ l'affixe consonantique `Ca` dans l'Emplacement VI du formatif. Il est à noter qu'en plus de la Configuration, cette affixe `Ca` indique aussi l'Affiliation, la Perspective, l'Extension et l'Essence du radical. Les vingt configurations sont décrites ci-dessous, chacune accompagnée de son affixe consonantique apparaissant dans l'Emplacement VI du formatif :
...
\* L'UNIPLEXE est indiqué par l'absence d'une affixe de Configuration ; Si toutes les affixes `Ca` ont leurs valeurs par défaut, la forme de `Ca` est -l-.

Il est à noter qu'un formatif en Configuration <abbr>DPX</abbr> seule indique qu'il s'agit d'une paire, sans expliciter ni la similarité ni la séparabilité des deux membres de cette paire.

Quelques Exemples de Configurations Diverses :
...
<div class="glend"><q>un chat</q></div>

<dl class="gloss">
    <dt>rrasa</dt>
    <dd>“chat”-<b>DPX</b></dd>
</dl>
<div class="glend"><q>une paire de chats</q></div>

<dl class="gloss">
    <dt>rraca</dt>
    <dd>“chat”-<b>DSS</b></dd>
</dl>
<div class="glend"><q>une paire de chats similaires</q></div>

<dl class="gloss">
    <dt>rraţsa</dt>
    <dd>“chat”-<b>DDS</b></dd>
</dl>
<div class="glend"><q>une paire de chats différents</q></div>

<dl class="gloss">
    <dt>rrata</dt>
    <dd>“chat”-<b>MSS</b></dd>
</dl>
<div class="glend"><q>un groupe de chats similaires</q></div>

<dl class="gloss">
    <dt>rraţa</dt>
    <dd>“chat”-<b>MDS</b></dd>
</dl>
<div class="glend"><q>un groupe de chats différents</q></div>

<dl class="gloss">
    <dt>rraza</dt>
    <dd>“chat”-<b>MFS</b></dd>
</dl>
<div class="glend"><q>un groupe de ce qui semble être des chats, certains plus que d'autres</q></div>

@tab Sphère

<dl class="gloss">
    <dt>anzwil</dt>
    <dd>“forme.sphérique”-OBJ-<b>UPX</b></dd>
</dl>
<div class="glend"><q>une sphère</q></div>

<dl class="gloss">
    <dt>anzwit</dt>
    <dd>“forme.sphérique”-OBJ-<b>MSS</b></dd>
</dl>
<div class="glend"><q>un groupe de sphères similaires</q></div>

<dl class="gloss">
    <dt>anzwik</dt>
    <dd>“forme.sphérique”-OBJ-<b>MSC</b></dd>
</dl>
<div class="glend"><q>un groupe de sphères similaires qui se touchent/connectées les unes aux autres</q></div>

<dl class="gloss">
    <dt>anzwip</dt>
    <dd>“forme.sphérique”-OBJ-<b>MSF</b></dd>
</dl>
<div class="glend"><q>un groupe de shères similaires fusionnées ensemble</q></div>

<dl class="gloss">
    <dt>anzwif</dt>
    <dd>“forme.sphérique”-OBJ-<b>MDC</b></dd>
</dl>
<div class="glend"><q>un groupe de sphères différentes qui se touchent/connectées les unes aux autres</q></div>

<dl class="gloss">
    <dt>anzwiç</dt>
    <dd>“forme.sphérique”-OBJ-<b>MDF</b></dd>
</dl>
<div class="glend"><q>un groupe de shères différentes fusionnées ensemble</q></div>

<dl class="gloss">
    <dt>anzwiž</dt>
    <dd>“forme.sphérique”-OBJ-<b>MFC</b></dd>
</dl>
<div class="glend"><q>un groupe d'objets arrondis qui se touchent/connectés les uns aux autres, dont certains sont plus sphériques que d'autres</q></div>

@tab Mouvement

<dl class="gloss">
    <dt>Blöfêi</dt>
    <dd>“mouvement.translatif.courbe”-DYN/OBJ-<b>MDC</b>-ASR/USP</dd>
</dl>
<dl class="gloss">
    <dt>onţlilu</dt>
    <dd>Stem.0-“automobile”-STA/OBJ-IND</dd>
</dl>
<div class="glend"><q>La voiture est conduite dans une série de virages de tailles variées.</q></div>

:::

::: warning Note du/de la Réviseur.e

*anzwu-* est remplacé par *anzwi-*, car c'est ce qui est induit dans la glose.

:::

## 3.2 L'Affiliation {#Sec3_2}

Alors que la catégorie de la Configuration de la section prédédente distingue les relations entre les membres individuels d'un groupe en termes de similarités physiques, de connexions physiques et de nombre d'entités-composants, la catégorie de l'Affiliation se charge de distinguer les relations entre les membres en termes de but, fonction ou bénéfice subjectifs. L'Affiliation complémente la Configuration afin de décrire la totalité des relations contextuelles entre les membres d'un groupe. Comme pour la Configuration, les significations des noms ou des verbes selon les diverses affiliations impliquent souvent des différences lexicales lors de la traduction en français.

Pour reprendre notre exemple précédent du mot _arbre_, nous avons vu qu'un groupe d'arbres devenait un bosquet dans la configuration <abbr>MSC</abbr>. Le mot _bosquet_ sous-entend que les arbres ont poussé naturellement, sans but ou fonction spécifiques donnés par la main humaine. D'un autre côté, les bosquets peuvent aussi être plantés à dessein, auquel cas ils deviennent des _vergers_. Nous avons vu que des arbres se présentant comme un assortiment naturel de différentes espèces est appelé une _forêt_. Cela dit, de tels assortiments peuvent devenir tout à fait chaotiques, affichant un désordre aléatoire du point de vue de la conception subjective humaine, devenant ainsi des _jungles_.

Autre exemple : le mot _personne_ devient _groupe_, ou _rassemblement_, deux mots qui sont neutres du point de vue du but ou de la fonction subjectifs. Cependant, appliquer l'idée d'une conception délibérée génère des mots comme _équipe_, tandis que l'absence d'objectif donne _foule_.

Il existe quatre affiliations : **CONSOLIDATIVE**, **ASSOCIATIVE**, **VARIATIVE** et **COALESCENTE**. Comme la Configuration, l'Affiliation est aussi indiquée par une partie du complexe affixal `Ca` de l'Emplacement VI du formatif. Une affixe d'Affiliation est située en première place du complexe affixal `Ca` de l'Emplacement VI, juste avant l'affixe de Configuration. Les détails des quatre affiliations sont expliqués ci-dessous avec leurs affixes.

### 3.2.1 <abbr>CSL</abbr> Le Consolidatif {#Sec3_2_1}

L'affiliation **CONSOLIDATIVE** est indiquée par une affixe vide, c'est-à-dire que l'absence d'une affixe d'Affiliation dans l'Emplacement VI signifie l'affiliation **CONSOLIDATIVE**. Cette affiliation signifie que les membres individuels d'un groupe configurationnel forment un ensemble d'origine naturelle où la fonction, l'état, l'objectif ou le bénéfice des membres individuels sont non applicables ou non pertinents, ou, si applicables, sont partagés. Elle diffère de l'affiliation **ASSOCIATIVE** ci-dessous en ce que le rôle des membres individuels du groupe n'est pas défini subjectivement par une conception humaine. Quelques exemples : _des branches d'arbre_, _un bosquet_, _un tas de cailloux_, _des gens_, _les nuages_.

Le **CONSOLIDATIF** est aussi l'affiliation par défaut des noms en configuration UNIPLEXE lorsqu'ils sont évoqués de manière neutre, puisqu'un nom UNIPLEXE spécifie une seule entité sans référence à un quelconque ensemble, donc le concept d'une fonction « partagée » ne serait pas applicable. Par exemple : _un homme_, _une porte_, _une sensation de chaleur_, _une feuille_. Pour un verbe, le **CONSOLIDATIF** impliquerait que l'action, l'état ou l'événement se produit naturellement, ou est neutre en termes de but ou d'obectif.

<div class="indent">
    <dl class="gloss">
      <dt>čväţa</dt>
    </dl>
    <div class="glend"><q>un paquet d'outils</q></div>
    <dl class="gloss">
      <dt>arsweţ</dt>
    </dl>
    <div class="glend"><q>un groupe de planètes</q></div>
    <dl class="gloss">
      <dt>zvata</dt>
    </dl>
    <div class="glend"><q>un ensemble/groupe de chiens similaires</q></div>
    <dl class="gloss">
      <dt>sřala</dt>
    </dl>
    <div class="glend"><q>une pièce</q></div>
</div>

::: warning Note du/de la Réviseur.e

*čve-* est remplacé par *čvä-* afin de correspondre à la définition du lexique.

*sřu-* est remplacé par *sřa-* car son interprétation n'est par naturellement <abbr>DYN</abbr>.

Veuillez noter que ces corrections s'appliquent aussi aux exemples suivants.

:::

### 3.2.2 <abbr>ASO</abbr> L'Associatif {#Sec3_2_2}
